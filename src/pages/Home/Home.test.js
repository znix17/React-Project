...
jest.mock("../Sections/CustomerReview/CustomerReview", () => () => <div data-testid="testimonials-section"></div>);
jest.mock("../Sections/About/About", () => () => <div data-testid="about-section"></div>);

describe("Home component", () => {
  test("renders the Hero, Specials, CustomerReview, and About sections", () => {
    render(<Home />);
